...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setPositiveButton(settingsMain.getGpsConfirm(), new DialogInterface.OnClickListener() {
        ...
        alertDialog.setNegativeButton(settingsMain.getGpsCancel(), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
        });
